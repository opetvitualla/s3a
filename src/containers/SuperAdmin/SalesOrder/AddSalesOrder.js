...
{(idx > 0) ? <button onClick={() => this.Splice(idx)} type="button" class="addMoreClosebtn" aria-label="Close"><span aria-hidden="true">×</span></button> : null}
                                                ...
                                                <Input type="text" className="form-control" name="salesOrder_job[]" value={this.props.salesOrder_job[idx]} onChange={(e, idx) => this.props.setJob(e, idx)} placeholder="Enter Job Name" required />
                                            </FormGroup>
                                        </Col>
                                    </Row>
